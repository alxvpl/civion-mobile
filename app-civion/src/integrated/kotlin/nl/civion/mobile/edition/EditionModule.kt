...
import nl.civion.mobile.integration.impl.DefaultCivionIntegration
import org.koin.core.module.Module

/**
 * CIVION-integrated edition wiring.
 *
 * The standalone edition has a file of the same name in its own source set, and only one of the
...
fun Module.civionEditionAdditions() {
    single<CivionIntegration> { DefaultCivionIntegration() }
}
